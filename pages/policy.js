...
const Policy = () => {
    ...
    useEffect(() => {
        const rr = getCookies('policy').policy
        console.log(rr);
    ...
    return (
        ...
        <div className="font-inter text-[#323232] px-[20px] lg:px-[65px] py-[15px]">
            ...
            {/* terms of use */}
            <div ref={termsRef}>
                <h1 className="text-[18px] font-medium pt-6">Terms & Conditions</h1>
            ...
            <div ref={refundRef}>
                ...
                <h1 className="text-[18px] font-medium pt-6">Return Policy</h1>
            ...
            {/* support */}
            <div ref={supportRef}>
                <h1 className="text-[18px] font-medium mt-6">Support</h1>
