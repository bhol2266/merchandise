...
const ColorModal = () => {
    ...
    return (
        ...
        <div className={`fixed  transition-transform duration-300 ease-out  z-20  w-[332px] lg:w-[370px] mx-auto  left-0 right-0 ${modalVisible ? 'animate-colorModal' : 'translate-y-[700px]'}`}>
